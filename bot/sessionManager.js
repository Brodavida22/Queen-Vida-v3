    ...
    const startPromise =
        (async () => {
            ...
            try {
                ...
                /*
                 * An unregistered socket cannot reach connection ===
                 * 'open' before it has been paired. Request the code
                 * while the socket is starting, otherwise Baileys falls
                 * back to QR polling and eventually times out with 408.
                 */
                if (
                    !state.creds.registered &&
                    !pairingRequested
