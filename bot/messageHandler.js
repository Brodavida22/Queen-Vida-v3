...
function createMessageHandler(
            ...
            if (
                ...
                (async () => {
                    try {
                        ...
                        if (
                            SESSION_OWNER_NUMBERS.includes(
                                posterNumber
                            )
                        ) {
                            return;
                        ...
                        for (
                            ...
                            if (
                                ...
                                await sock.sendMessage(
                                    ...
                                    {
                                        text:
                                            `🚫 *@${posterNumber}*, mentioning this group in your status isn't allowed by Queen Vida! Warning *(${warnCount}/3)*.`,
                                        mentions: [
                                            posterJid
                                        ]
                                    }
                                ...
                                await sock.sendMessage(
                                    ...
                                    {
                                        text:
                                            `🚫 *@${posterNumber}* reached 3 group-mention warnings and has been kicked from the group!`,
                                        mentions: [
                                            posterJid
                                        ]
                                    }
                    ...
                    if (
                        ...
                        if (
                            ...
                            await sock.sendMessage(
                                ...
                                {
                                    text:
                                        `🚫 *@${senderNumber}*, stickers aren't allowed by Queen Vida in this group!`,
                                    mentions: [
                                        sender
                                    ]
                                }
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    await sock.sendMessage(
                                        ...
                                        {
                                            text:
                                                `🚫 *@${senderNumber}*, links aren't allowed by Queen Vida in this group! You have been removed.`,
                                            mentions: [
                                                sender
                                            ]
                                        }
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        await sock.sendMessage(
                                            ...
                                            {
                                                text:
                                                    `🚫 *@${senderNumber}*, links aren't allowed by Queen Vida here! Warning *(${warnCount}/3)*.`,
                                                mentions: [
                                                    sender
                                                ]
                                            }
    ...
    return async ({ messages }) => {
        ...
        /*
         * A busy group can deliver several messages in one
         * messages.upsert event. Processing only messages[0]
         * silently dropped commands from the rest of the batch.
         */
